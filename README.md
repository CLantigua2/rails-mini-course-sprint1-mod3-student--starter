...
> The create function in the task_controller.rb file handles the form submission. The views/tasks/new.html.erb handles the form submission in the frontend.
